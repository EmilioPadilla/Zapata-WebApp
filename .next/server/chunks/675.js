...
exports.modules = {
	...
	/***/ 45: /***/ (module, exports, __webpack_require__) => {
		'use strict';
			...
			return /*#__PURE__*/ _react.default.createElement(
				...
				/*#__PURE__*/ _react.default.createElement(
					...
					hasSizer
						...
						: null,
					/*#__PURE__*/ _react.default.createElement(ImageElement, Object.assign({}, imgElementArgs))
				),
		...
		function defaultLoader({config, src, width, quality}) {
			...
			return `${(0, _normalizeTrailingSlash).normalizePathTrailingSlash(config.path)}?url=${encodeURIComponent(
				src
